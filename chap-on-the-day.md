...
カンファレンスのタイムテーブルが決まっている場合は、タイムテーブルを参考にアウトプットの構成(目次)を作っておきます。特にタイムテーブルがない場合は、アウトプットのひな型を作ります。びばさんが紹介しているふりかえりカタログやふりかえりチートシートを参考にして作りました。ひな型や目次を作ると同時に、どんな内容になりそうかを頭の中でシュミレーションしておきます。
